...
**Versi Rilis Saat Ini:** `1.1.15` (Version Code: `17`)
...
| **Version Name** | `1.1.15` | Nomor versi yang tampil kepada pengguna di toko |
| **Version Code** | `17` | Nomor integer inkremental untuk Play Console |
...
| **Format File Upload** | **Android App Bundle (`.aab`)** | File: `release/CycleJournal_v1.1.15.aab` |
| **Format File Testing Fisik** | **Release APK (`.apk`)** | File: `release/CycleJournal_v1.1.15.apk` |
...
|---|---|
| **File Rilis AAB (Wajib Upload)** | 📁 `release/CycleJournal_v1.1.15.aab` (Version Code: 17) |
| **File Rilis APK (Install Uji Coba)** | 📁 `release/CycleJournal_v1.1.15.apk` |
