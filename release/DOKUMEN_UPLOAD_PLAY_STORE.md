...
**Versi Rilis Saat Ini:** `1.1.18` (Version Code: `20`)
...
| **Version Name** | `1.1.18` | Nomor versi yang tampil kepada pengguna di toko |
| **Version Code** | `20` | Nomor integer inkremental untuk Play Console |
...
| **Format File Upload** | **Android App Bundle (`.aab`)** | File: `release/CycleJournal_v1.1.18.aab` |
| **Format File Testing Fisik** | **Release APK (`.apk`)** | File: `release/CycleJournal_v1.1.18.apk` |
...
|---|---|
| **File Rilis AAB (Wajib Upload)** | 📁 `release/CycleJournal_v1.1.18.aab` (Version Code: 20) |
| **File Rilis APK (Install Uji Coba)** | 📁 `release/CycleJournal_v1.1.18.apk` |
