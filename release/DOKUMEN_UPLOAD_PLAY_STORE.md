...
**Versi Rilis Saat Ini:** `1.1.19` (Version Code: `21`)
...
| **Version Name** | `1.1.19` | Nomor versi yang tampil kepada pengguna di toko |
| **Version Code** | `21` | Nomor integer inkremental untuk Play Console |
...
| **Format File Upload** | **Android App Bundle (`.aab`)** | File: `release/CycleJournal_v1.1.19.aab` |
| **Format File Testing Fisik** | **Release APK (`.apk`)** | File: `release/CycleJournal_v1.1.19.apk` |
...
|---|---|
| **File Rilis AAB (Wajib Upload)** | 📁 `release/CycleJournal_v1.1.19.aab` (Version Code: 21) |
| **File Rilis APK (Install Uji Coba)** | 📁 `release/CycleJournal_v1.1.19.apk` |
