...
**Versi Rilis Saat Ini:** `1.1.17` (Version Code: `19`)
...
| **Version Name** | `1.1.17` | Nomor versi yang tampil kepada pengguna di toko |
| **Version Code** | `19` | Nomor integer inkremental untuk Play Console |
...
| **Format File Upload** | **Android App Bundle (`.aab`)** | File: `release/CycleJournal_v1.1.17.aab` |
| **Format File Testing Fisik** | **Release APK (`.apk`)** | File: `release/CycleJournal_v1.1.17.apk` |
...
|---|---|
| **File Rilis AAB (Wajib Upload)** | 📁 `release/CycleJournal_v1.1.17.aab` (Version Code: 19) |
| **File Rilis APK (Install Uji Coba)** | 📁 `release/CycleJournal_v1.1.17.apk` |
