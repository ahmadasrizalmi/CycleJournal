...
**Versi Rilis Saat Ini:** `1.1.12` (Version Code: `14`)
...
| **Version Name** | `1.1.12` | Nomor versi yang tampil kepada pengguna di toko |
| **Version Code** | `14` | Nomor integer inkremental untuk Play Console |
...
| **Format File Upload** | **Android App Bundle (`.aab`)** | File: `release/CycleJournal_v1.1.12.aab` |
| **Format File Testing Fisik** | **Release APK (`.apk`)** | File: `release/CycleJournal_v1.1.12.apk` |
...
|---|---|
| **File Rilis AAB (Wajib Upload)** | 📁 `release/CycleJournal_v1.1.12.aab` (Version Code: 14) |
| **File Rilis APK (Install Uji Coba)** | 📁 `release/CycleJournal_v1.1.12.apk` |
