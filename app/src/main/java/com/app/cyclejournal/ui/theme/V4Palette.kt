...
class V4Palette(
    ...
    val painModerateFill: Color,
    val painModerateInk: Color,
    val painHighFill: Color,
    val painHighInk: Color,
    val painCriticalFill: Color,
    val painCriticalInk: Color,
    val fieldLine: Color,
...
val LightV4Palette = V4Palette(
    ...
    painModerateFill = Color(0xFFFFFBEB),
    painModerateInk = Color(0xFFB45309),
    painHighFill = Color(0xFFFFF1F2),
    painHighInk = Color(0xFFBE123C),
    painCriticalFill = Color(0xFFFEE2E2),
    painCriticalInk = Color(0xFF991B1B),
    fieldLine = Color(0xFFD3CFDA),
...
val DarkV4Palette = V4Palette(
    ...
    painModerateFill = Color(0xFF3A2E14),
    painModerateInk = Color(0xFFF0C36B),
    painHighFill = Color(0xFF3A1D28),
    painHighInk = Color(0xFFF5A3B8),
    painCriticalFill = Color(0xFF43191B),
    painCriticalInk = Color(0xFFFCA5A5),
    fieldLine = Color(0xFF3A373F),
